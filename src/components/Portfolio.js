...
export default function Portfolio() {
  const projects = [
    {
      name: 'Tech Blog',
      description: 'Blogging website for tech geeks to come together and geek out on all things tech. Designed to test the developer\'s skills related to the Model-View-Controller pattern.',
    ...
    },
    {
      ...
      description: 'This app will allow the user to input a city name, and a five day weather forecast will pull from a separate weather applications API and display using dynamically updated HTML and CSS.',
    ...
    },
    {
      ...
      description: 'Website for managing online subscriptions. Built as part of a group project to test back end skills.',
    ...
    },
    {
      ...
      description: 'Website that pulls comics and subreddit pages for selected Marvel characters. Built as part of a group project to test front end skills and API pulls.',
    ...
    {
      name: 'Note Taker',
      description: 'Note-taking app designed to test the developer\'s ability to implement back-end code to a pre-existing front-end codebase, and show off their Express.js and Heroku deployment skills.',
    ...
    },
    {
      ...
      description: 'Code refactor to add interactive functionality to professional day planner utilizating Third Party APIs and saving to local storage.',
